...
const TIMEFRAME_CARDS: TimeframeTheme[] = [
  {
    ...
    activeCard:
      'bg-emerald-50/80 dark:bg-[#091f16] border-emerald-500 dark:border-emerald-400 shadow-md shadow-emerald-500/10 ring-1 ring-emerald-500/30 dark:ring-emerald-400/40',
    inactiveCard:
      'bg-white dark:bg-[#161920] border-slate-200 dark:border-white/10 hover:border-emerald-300 dark:hover:border-emerald-500/40 hover:shadow-xs',
    topBarColor: 'bg-emerald-500',
    iconContainerActive:
      'bg-emerald-100 dark:bg-emerald-500/20 border-emerald-300 dark:border-emerald-500/40 text-emerald-600 dark:text-emerald-300',
    iconContainerInactive:
      'bg-emerald-50/60 dark:bg-emerald-950/40 border-emerald-200/60 dark:border-emerald-900/40 text-emerald-500/70 dark:text-emerald-400/70',
    titleColorActive: 'text-emerald-700 dark:text-emerald-300',
    titleColorInactive: 'text-slate-700 dark:text-slate-300',
    heroContainer:
      'bg-gradient-to-br from-emerald-50/90 to-teal-50/40 dark:from-[#06241a] dark:via-[#041a13] dark:to-[#02130e] border-emerald-300/80 dark:border-emerald-500/40 shadow-lg shadow-emerald-500/5 dark:shadow-[0_8px_32px_rgba(5,150,105,0.2)]',
    progressBarFill:
      'bg-gradient-to-r from-emerald-500 via-teal-400 to-emerald-300 dark:from-emerald-400 dark:via-teal-300 dark:to-emerald-200 shadow-sm dark:shadow-[0_0_15px_rgba(52,211,153,0.8)]',
    progressTrackBg:
      'bg-slate-200/80 dark:bg-black/60 border border-slate-300/80 dark:border-emerald-500/30',
    badgeClass:
      'bg-emerald-100 text-emerald-800 border-emerald-300 dark:bg-emerald-500/20 dark:text-emerald-300 dark:border-emerald-400/40',
  ...
  },
  {
    ...
    activeCard:
      'bg-sky-50/80 dark:bg-[#071e2e] border-sky-500 dark:border-sky-400 shadow-md shadow-sky-500/10 ring-1 ring-sky-500/30 dark:ring-sky-400/40',
    inactiveCard:
      'bg-white dark:bg-[#161920] border-slate-200 dark:border-white/10 hover:border-sky-300 dark:hover:border-sky-500/40 hover:shadow-xs',
    topBarColor: 'bg-sky-500',
    iconContainerActive:
      'bg-sky-100 dark:bg-sky-500/20 border-sky-300 dark:border-sky-500/40 text-sky-600 dark:text-sky-300',
    iconContainerInactive:
      'bg-sky-50/60 dark:bg-sky-950/40 border-sky-200/60 dark:border-sky-900/40 text-sky-500/70 dark:text-sky-400/70',
    titleColorActive: 'text-sky-700 dark:text-sky-300',
    titleColorInactive: 'text-slate-700 dark:text-slate-300',
    heroContainer:
      'bg-gradient-to-br from-sky-50/90 to-blue-50/40 dark:from-[#071d30] dark:via-[#051524] dark:to-[#030e1a] border-sky-300/80 dark:border-sky-500/40 shadow-lg shadow-sky-500/5 dark:shadow-[0_8px_32px_rgba(14,165,233,0.2)]',
    progressBarFill:
      'bg-gradient-to-r from-sky-500 via-cyan-400 to-blue-300 dark:from-sky-400 dark:via-cyan-300 dark:to-blue-200 shadow-sm dark:shadow-[0_0_15px_rgba(56,189,248,0.8)]',
    progressTrackBg:
      'bg-slate-200/80 dark:bg-black/60 border border-slate-300/80 dark:border-sky-500/30',
    badgeClass:
      'bg-sky-100 text-sky-800 border-sky-300 dark:bg-sky-500/20 dark:text-sky-300 dark:border-sky-400/40',
  ...
  },
  {
    ...
    activeCard:
      'bg-violet-50/80 dark:bg-[#1a0a2e] border-violet-500 dark:border-violet-400 shadow-md shadow-violet-500/10 ring-1 ring-violet-500/30 dark:ring-violet-400/40',
    inactiveCard:
      'bg-white dark:bg-[#161920] border-slate-200 dark:border-white/10 hover:border-violet-300 dark:hover:border-violet-500/40 hover:shadow-xs',
    topBarColor: 'bg-violet-500',
    iconContainerActive:
      'bg-violet-100 dark:bg-violet-500/20 border-violet-300 dark:border-violet-500/40 text-violet-600 dark:text-violet-300',
    iconContainerInactive:
      'bg-violet-50/60 dark:bg-violet-950/40 border-violet-200/60 dark:border-violet-900/40 text-violet-500/70 dark:text-violet-400/70',
    titleColorActive: 'text-violet-700 dark:text-violet-300',
    titleColorInactive: 'text-slate-700 dark:text-slate-300',
    heroContainer:
      'bg-gradient-to-br from-violet-50/90 to-purple-50/40 dark:from-[#1b0933] dark:via-[#130624] dark:to-[#0c0419] border-violet-300/80 dark:border-violet-500/40 shadow-lg shadow-violet-500/5 dark:shadow-[0_8px_32px_rgba(139,92,246,0.2)]',
    progressBarFill:
      'bg-gradient-to-r from-violet-500 via-fuchsia-400 to-purple-300 dark:from-violet-400 dark:via-fuchsia-300 dark:to-purple-200 shadow-sm dark:shadow-[0_0_15px_rgba(167,139,250,0.8)]',
    progressTrackBg:
      'bg-slate-200/80 dark:bg-black/60 border border-slate-300/80 dark:border-violet-500/30',
    badgeClass:
      'bg-violet-100 text-violet-800 border-violet-300 dark:bg-violet-500/20 dark:text-violet-300 dark:border-violet-400/40',
  ...
  },
  {
    ...
    activeCard:
      'bg-amber-50/80 dark:bg-[#241306] border-amber-500 dark:border-amber-400 shadow-md shadow-amber-500/10 ring-1 ring-amber-500/30 dark:ring-amber-400/40',
    inactiveCard:
      'bg-white dark:bg-[#161920] border-slate-200 dark:border-white/10 hover:border-amber-300 dark:hover:border-amber-500/40 hover:shadow-xs',
    topBarColor: 'bg-amber-500',
    iconContainerActive:
      'bg-amber-100 dark:bg-amber-500/20 border-amber-300 dark:border-amber-500/40 text-amber-600 dark:text-amber-300',
    iconContainerInactive:
      'bg-amber-50/60 dark:bg-amber-950/40 border-amber-200/60 dark:border-amber-900/40 text-amber-500/70 dark:text-amber-400/70',
    titleColorActive: 'text-amber-700 dark:text-amber-300',
    titleColorInactive: 'text-slate-700 dark:text-slate-300',
    heroContainer:
      'bg-gradient-to-br from-amber-50/90 to-yellow-50/40 dark:from-[#261304] dark:via-[#1c0d03] dark:to-[#120902] border-amber-300/80 dark:border-amber-500/40 shadow-lg shadow-amber-500/5 dark:shadow-[0_8px_32px_rgba(245,158,11,0.2)]',
    progressBarFill:
      'bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-300 dark:from-amber-400 dark:via-yellow-300 dark:to-amber-100 shadow-sm dark:shadow-[0_0_15px_rgba(251,191,36,0.8)]',
    progressTrackBg:
      'bg-slate-200/80 dark:bg-black/60 border border-slate-300/80 dark:border-amber-500/30',
    badgeClass:
...
export const RevenueGoalsPage: React.FC = () => {
  ...
  const currentTheme =
    TIMEFRAME_CARDS.find((c) => c.id === timeframe) || TIMEFRAME_CARDS[0];
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto select-none animate-fade-in text-slate-900 dark:text-slate-100 relative">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 font-medium">
                Real-time financial benchmark tracker aggregating POS retail
                sales and logbook attendance entry fees.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <div
                    className={`p-2 rounded-xl border transition-colors ${
                      isSelected
                        ? card.iconContainerActive
                        : card.iconContainerInactive
                    }`}
                  >
                    {card.icon}
                  </div>
                  <div>
                    <span
                      className={`text-[11px] font-heading font-black tracking-wider uppercase block ${
                        isSelected
                          ? card.titleColorActive
                          : card.titleColorInactive
                      }`}
                    >
                      {card.label}
                    </span>
                ...
                {isSelected && (
                  <span className="flex h-2 w-2 relative">
                    <span
                      className={`animate-ping absolute inline-flex h-full w-full rounded-full ${card.topBarColor} opacity-75`}
                    />
                    <span
                      className={`relative inline-flex rounded-full h-2 w-2 ${card.topBarColor}`}
                    />
                  </span>
                )}
              </div>
              ...
              <div className="mt-4">
                ...
                <div className="flex items-center justify-between text-[10.5px] font-mono font-medium text-slate-400 dark:text-slate-400 mt-1">
                  ...
                  <ArrowUpRight
                    className={`w-3.5 h-3.5 transition-transform ${isSelected ? `${card.accentText} translate-x-0.5 -translate-y-0.5` : 'opacity-0 group-hover:opacity-100'}`}
                  />
                </div>
              </div>
            </button>
      ...
      <div
        className={`relative overflow-hidden rounded-3xl border p-6 sm:p-8 transition-all duration-300 ${currentTheme.heroContainer}`}
      >
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-8">
          ...
          <div className="space-y-4 flex-1">
            <div className="flex flex-wrap items-center gap-2">
              <span
                className={`px-3 py-1 rounded-lg text-[10px] font-sans font-black tracking-wider uppercase border backdrop-blur-md ${currentTheme.badgeClass}`}
              >
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 dark:text-slate-300 mt-1 font-medium max-w-xl">
                Real-time synchronized revenue combining hardware gate passes
                and POS checkout register inventory sales.
              </p>
            </div>
            ...
            <div className="space-y-2 pt-2">
              <div
                className={`w-full h-4 rounded-full overflow-hidden p-0.5 ${currentTheme.progressTrackBg}`}
              >
                <motion.div
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3.5 lg:w-84 shrink-0">
            {/* Passes Tile */}
            <div
              className={`p-4 rounded-2xl border backdrop-blur-md flex items-center justify-between shadow-xs ${currentTheme.chipBg} ${currentTheme.chipBorder}`}
            >
      ...
      <div className="bg-white dark:bg-[#161920] border border-slate-200 dark:border-white/10 rounded-3xl p-6 sm:p-8 shadow-xs space-y-6">
        <div className="flex items-center justify-between border-b border-slate-100 dark:border-white/5 pb-4">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
              Adjust benchmark targets for your facility. Updates will save
              directly to Supabase and immediately sync across all terminals.
            </p>
          </div>
        </div>
        ...
        {saveSuccess && (
          ...
          >
            ...
            <span>
              Goal targets saved successfully and synced across all dashboard
              modules.
            </span>
          </motion.div>
        )}
        ...
        >
          ...
          <div className="sm:col-span-2 lg:col-span-4 flex items-center justify-end gap-2 pt-3">
            ...
            >
              ...
              <span>
                {isSaving ? 'Saving to Database...' : 'Save All Goal Targets'}
              </span>
            </button>
          </div>
        </form>
