  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
      ...
      <div
        ...
        className="group col-span-1 bg-white dark:bg-[#161920] border border-slate-200/80 dark:border-slate-800/80 hover:border-[#123c73]/50 dark:hover:border-blue-500/50 rounded-2xl p-3.5 sm:p-4 shadow-xs hover:shadow-md transition-all duration-200 cursor-pointer active:scale-[0.98] flex flex-col justify-between"
      >
        <div className="flex items-start justify-between gap-2">
          ...
          <span className="text-[10px] font-bold bg-blue-50 text-blue-700 dark:bg-blue-950 dark:text-blue-300 px-2 py-0.5 rounded-md">
        ...
        <div className="mt-3">
          ...
          <div className="flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 mt-1">
            <span>{metrics.totalMembersCount} registered</span>
            <ArrowRight className="w-3.5 h-3.5 text-slate-400 group-hover:translate-x-1 group-hover:text-[#123c73] dark:group-hover:text-blue-400 transition-all" />
          </div>
        </div>
      </div>
      ...
      <div
        ...
        className="group col-span-1 bg-white dark:bg-[#161920] border border-slate-200/80 dark:border-slate-800/80 hover:border-emerald-500/50 dark:hover:border-emerald-500/50 rounded-2xl p-3.5 sm:p-4 shadow-xs hover:shadow-md transition-all duration-200 cursor-pointer active:scale-[0.98] flex flex-col justify-between"
      >
        <div className="flex items-start justify-between gap-2">
      ...
      <div
        ...
        className="group col-span-2 sm:col-span-1 bg-white dark:bg-[#161920] border border-slate-200/80 dark:border-slate-800/80 hover:border-indigo-500/50 dark:hover:border-indigo-500/50 rounded-2xl p-3.5 sm:p-4 shadow-xs hover:shadow-md transition-all duration-200 cursor-pointer active:scale-[0.98] flex flex-col justify-between"
      >
        <div className="flex items-start justify-between gap-2">
        ...
        <div className="mt-3">
          ...
          <div className="flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 mt-1">
            ...
            <ArrowRight className="w-3.5 h-3.5 text-slate-400 group-hover:translate-x-1 group-hover:text-indigo-500 transition-all" />
          </div>
        </div>
      </div>
      ...
      <div
        ...
        className="group col-span-1 bg-white dark:bg-[#161920] border border-amber-200/80 dark:border-amber-900/50 hover:border-amber-400 rounded-2xl p-3.5 sm:p-4 shadow-xs hover:shadow-md transition-all duration-200 cursor-pointer active:scale-[0.98] flex flex-col justify-between"
      >
        <div className="flex items-start justify-between gap-2">
          ...
          <span className="text-[10px] font-extrabold bg-amber-100 text-amber-900 dark:bg-amber-950 dark:text-amber-300 px-2 py-0.5 rounded-md">
            Next 7 Days
          </span>
        </div>
        ...
        <div className="mt-3">
          ...
          <div className="flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 mt-1">
            ...
            <ArrowRight className="w-3.5 h-3.5 text-amber-500 group-hover:translate-x-1 transition-all" />
          </div>
        </div>
      </div>
      ...
      <div
        ...
        className="group col-span-1 bg-white dark:bg-[#161920] border border-rose-200/80 dark:border-rose-900/50 hover:border-rose-400 rounded-2xl p-3.5 sm:p-4 shadow-xs hover:shadow-md transition-all duration-200 cursor-pointer active:scale-[0.98] flex flex-col justify-between"
      >
        <div className="flex items-start justify-between gap-2">
          ...
          <span className="text-[10px] font-extrabold bg-rose-100 text-rose-800 dark:bg-rose-950 dark:text-rose-300 px-2 py-0.5 rounded-md">
