...
export const DigitalQRCardModal: React.FC<DigitalQRCardModalProps> = ({
  ...
  const [expireDate, setExpireDate] = useState<string>(() => {
    if (subscription?.end_date) {
      return new Date(subscription.end_date).toISOString().split('T')[0];
    }
    const d = new Date();
  ...
  return createPortal(
    <div className="fixed inset-0 z-110 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in font-body text-xs text-white">
      ...
      <div className="bg-zinc-950 border border-zinc-800 rounded-3xl w-full max-w-lg shadow-2xl p-6 space-y-5">
        ...
        {/* EXPIRATION & CONFIGURATION CONTROLS */}
            ...
            <div className="space-y-3 pt-1 animate-fade-in">
              ...
              <div className="flex flex-wrap items-center gap-1.5 pt-1">
                ...
                <button
                  ...
                  className="px-2 py-1 bg-red-600/20 hover:bg-red-600/30 text-red-400 border border-red-500/30 rounded-lg text-[9px] font-heading font-bold uppercase cursor-pointer flex items-center gap-1"
                >
        ...
        {/* 1:1 ATHLETIC DIGITAL CARD PREVIEW */}
        ...
        <div className="flex gap-3 pt-2">
          ...
          >
            ...
            <span>Print Official QR Card</span>
          </button>
        </div>
